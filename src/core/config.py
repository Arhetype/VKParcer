...
class Config(BaseConfig):
    ...
    def load_config(self) -> None:
        ...
        Выполни академический анализ текстовых отзывов пользователей социальной сети. 
        Проанализируй следующие текстовые данные и классифицируй их по эмоциональной окраске:
        
        1. Подсчитай количество положительных отзывов
        2. Подсчитай количество отрицательных отзывов  
        3. Подсчитай количество нейтральных отзывов
        4. Выдели основные положительные аспекты (по отзывам)
        5. Выдели основные отрицательные аспекты (по отзывам)
        6. Определи общую оценку эмоционального тона (от 1 до 10)
        7. Предложи рекомендации для улучшения
